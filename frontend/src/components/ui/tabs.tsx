...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex min-h-touch min-w-touch items-center justify-center rounded-sm px-3 py-1.5 ' +
        'text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 ' +
        'focus-visible:ring-ring data-[state=active]:bg-background data-[state=active]:text-foreground ' +

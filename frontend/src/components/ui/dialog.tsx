...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 ' +
          'gap-4 rounded-lg border border-border bg-background p-5 shadow-lg ' +
          'focus:outline-none',
        className,
      )}
      {...props}
